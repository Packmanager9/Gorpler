    ...
    class Gorpler {
        ...
        draw() {
            if (this.dead < 128) {
                ...
                this.arms2[this.arms.length - 1].anchor.radius = 9
                this.legs2[this.arms.length - 1].anchor.radius = 9
                if (this.dead == 0) {
                    this.body.move()
                }
                this.body.draw()
                ...
                if(this.leglock+this.leglock2+this.armlock+this.armlock2 >= 1){
                        gamepad_control(this.legs[this.arms.length - 1].anchor, 2.8)
                }else{
                ...
                if (this.armlock2 != 0) {
                    ...
                    // if (this.bodywet != 0 || this.leglock == 1) {
                if(this.leglock+this.leglock2+this.armlock+this.armlock2 >= 1){
                        gamepad_control(this.arms2[this.arms.length - 1].anchor, 2.8)
                }else{
                ...
                if (this.dead == 0) {
                    ...
                    canvas_context.fillStyle = "blue"
                    canvas_context.fillText('A', this.legs2[this.legs.length - 1].anchor.x - 4, this.legs2[this.arms.length - 1].anchor.y + 4)
                    canvas_context.fillStyle = "blue"
                    canvas_context.fillText('Y', this.arms2[this.arms.length - 1].anchor.x - 4, this.arms2[this.arms.length - 1].anchor.y + 4)
                }
            } else {
